package kr.co.lnkbeauty.hairtouch_android.base;
 ...
 */
public class HTMessageDialog extends Dialog {
    ...
    public HTMessageDialog(Context context, String title, String message, View.OnClickListener onClickListener) {
